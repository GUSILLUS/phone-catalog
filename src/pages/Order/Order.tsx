          ...
          >
            <fieldset className="order__fieldset">
              <div className="order__fieldset-title">
                ...
                <h2 className="order__fieldset-legend">
              ...
              <div className="order__statements">
                <div className="order__checkbox">
                  ...
                  >
                    ...
                    inspecting the goods upon receipt,
                    and I agree to make payment only
                    after confirming their completeness according to the
                    agreed-upon standards. The inspection must be completed
                    on the day of receipt.If any issues are not reported
                    on the day of receipt, it will be assumed
                    that the goods are satisfactory,
                    and payment will be expected accordingly.
                  </label>
                </div>
                <div className="order__checkbox">
                  <input
          ...
          <div className="cart__total-box">
            ...
            <div className="order__items">
              {products.map(product => (
                <div className="order__total-item" key={product.name}>
                  <p className="order__total-item-name">
                    {product.name}
                  </p>
